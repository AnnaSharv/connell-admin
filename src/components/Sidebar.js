...
useEffect(() => {
  ...
  // useEffect(() => {
  //   const blogsRef = collection(db, "props.blogsLength");
  //   const unsub = onSnapshot(blogsRef, (snapShot) => {
  //     let list = [];
  ...
  const items = [
    ...
    {
        label: (
          <Link to="bloglist/all"  rel="noopener noreferrer">
    ...
    {
        label: (
          <Link to="members"  rel="noopener noreferrer">
    ...
    {
        label: (
          <Link to="transactions"  rel="noopener noreferrer">
  ...
  return (
    ...
    >
      ...
      />
        ...
        {/* <Menu>
        <Menu.Item to="/Website pages"  key="1">
        <Link to="pages"  rel="noopener noreferrer">
           <span> <img src={icon7} /> </span>  
           <span>Website pages</span> 
          </Link>
...
<div className="my-divier">
        <Menu.Item to="/pages" key="3">
        <Link to="pages"  rel="noopener noreferrer">
           <span><img src={icon6} /></span>  
           <span>Pages</span> 
          </Link>
        ...
        <Menu.Item to="/bloginside" key="4">
        <Link to="bloginside"  rel="noopener noreferrer">
           <span><img src={icon1} /></span>  
           <span>Blogs</span> 
          </Link>
        </Menu.Item> 
        ...
        <Menu.Item to="/transactions" key="6">
          <Link to="transactions"  rel="noopener noreferrer">
           <span><img src={icon5} /></span>  
           <span>Transactions</span> 
          </Link>
