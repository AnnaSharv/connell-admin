...
import { getFirestore, collection, query, doc, updateDoc, onSnapshot,  orderBy } from "firebase/firestore";
...
function handleClick() {
  ...
  for (const obj of blogsAll) {
    
      obj.pos = Math.ceil(Math.random() * 10)
