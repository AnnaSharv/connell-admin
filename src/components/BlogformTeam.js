            ...
            <div>
                ...
                <div className='upload_image_wrapper'>
                    <div>
                        ...
                        <span> {memberImg.name || formRef.current?.values.blog_image_name  || "Upload main image..."} {formatBytes(formRef.current?.values.blog_image_size) || formatBytes(memberImg.size)}</span>
                    </div>
                    ...
                    <fieldset>
                        <div className='blog_form_details'>
                            ...
                            <div className='content_wrapper '>
                                ...
                                <ModalPreview cat={"team"} vals={formik.values} img={memberImg}/>
                            </div>
