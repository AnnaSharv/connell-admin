...
import { collection, addDoc, doc,  setDoc, getDoc, getDocs, deleteDoc, increment, updateDoc } from "firebase/firestore";
                ...
                <Form onSubmit={formik.handleSubmit} className="blog_form">
                    <fieldset>
                        ...
                        <div className="blog_form_header blog_form_header_transactions">
                            ...
                            <Field type="text"  name="transactions_year" placeholder='year'/>
                        </div>
                    </fieldset>
